...
% 条件の値を入力するポップアップを表示
prompt = {'Enter frequency of imaging (freq, e.g., 1):', ...
          'Enter threshold for npix (ROI size) (e.g., 2.5 * 2.5 * 3.14):', ...
          'Enter MINIMUM of y_range / x_range ratio (e.g., 0.5 for soma):', ...
          'Enter MAXIMUM of y_range / x_range ratio (e.g., 2 for soma):'};
dlg_title = 'Set Conditions';
num_lines = 1;
default_ans = {'1', '30', '0.5', '2.0'}; % デフォルト値を調整
